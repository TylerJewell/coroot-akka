...
A `LICENSE-coroot` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [coroot/coroot](https://github.com/coroot/coroot), Copyright
2020-present Coroot, Inc, licensed under Apache-2.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../coroot-port/specs/SPEC-001-coroot.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
